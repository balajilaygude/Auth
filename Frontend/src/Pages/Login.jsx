  ...
  return (
    <div className="min-w-screen min-h-screen bg-sky-100 flex flex-col justify-center items-center">
      <div className="lg:w-3/5 w-4/5 h-92 bg-white flex justify-center items-center flex-col rounded-2xl shadow-2xl shadow-sky-500">
        <h2 className="text-4xl font-semibold my-5 text-sky-500">Login</h2>
        <form className="flex flex-col w-4/5 " onSubmit={handleSubmit}>
          <input
            onChange={handleChange}
            value={loginInfo.email}
            className="mb-3 p-2 border-2 placeholder:text-sky-500
           text-sky-500 outline-sky-600 border-sky-500 rounded-lg"
            type="email"
            name="email"
            placeholder="Email"
          />
          ...
          />
          <button className="bg-sky-500 w-3/12 mb-2 mx-auto rounded-2xl px-3 py-1 text-white hover:bg-white hover:text-sky-500 border border-sky-500 h-12 cursor-pointer">
            {" "}
        ...
        <p className="text-sky-500">
          ...
          <span className="cursor-pointer hover:text-sky-800">
